...
public class SuperAdminFrame extends JFrame {
	...
	private SuperAdminPanelViewConsumer panelViewConsumer;
	...
	public SuperAdminFrame() {
		...
		panelViewConsumer = new SuperAdminPanelViewConsumer();
		...
		JLabel lblNewLabel = new JLabel("SuperAdmin Dashboard");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.BOLD, 14));
		lblNewLabel.setForeground(Color.WHITE);
		lblNewLabel.setBounds(33, 6, 175, 16);
